...
## Constants
CODE_DIRECTORY = 'nagios_graphite'
DOCS_DIRECTORY = 'docs'
...
#
# However, when we do this, we also import `nagios_graphite/__init__.py'. If
...
# metadata has no dependencies, otherwise they will need to be added to the
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'nagios_graphite = nagios_graphite.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'nagios_graphite_gui = nagios_graphite.gui:entry_point'
        # ]
    }
)
